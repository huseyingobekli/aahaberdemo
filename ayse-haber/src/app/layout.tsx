  ...
  return (
    <html lang="tr">
      <body className={inter.className}>
        <nav className={`aa-topbar${compact ? ' compact' : ''}`} style={{ position: 'relative' }}>
          <div className="aa-topbar-inner">
            ...
            {compact && (
              <div className="aa-topbar-page-title" title={pageTitle}>{pageTitle}</div>
            )}
            <div className="aa-topbar-right">
              <button className="aa-icon-button" aria-label="Ara">🔍</button>
              <button className="aa-icon-button" aria-label="Menü" onClick={() => setMenuOpen(true)}>≡</button>
            </div>
          </div>
          ...
          {menuOpen && (
            <div className="aa-mega-overlay" onClick={() => setMenuOpen(false)}>
              <div className="aa-mega" onClick={(e) => e.stopPropagation()}>
                ...
                <button className="aa-mega-close" onClick={() => setMenuOpen(false)}>✕</button>
              </div>
            </div>
          )}
        </nav>
