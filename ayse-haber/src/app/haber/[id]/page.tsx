                ...
                <div className="article-content-wrapper">
                  <div className="article-text-section">
                    <div className="article-meta">
                      <h2 className="article-location">{currentItem.location || currentItem.city || ' '}</h2>
                    </div>
                    <div className="article-content">
                      <TTSPlayer text={articleText} variant="default" />
                      {topParagraphs.length > 0 ? (
                        topParagraphs.map((p, i) => (
                          <p key={i} className={i === 0 ? 'article-lead' : undefined}>{p}</p>
                        ))
                      ) : (
                  ...
                  <div className="photo-slider">
                    <div className="photo-container">
                      ...
                      <div className="photo-overlay">
                        <div className="photo-credit">{currentItem.credit || ""}</div>
                      </div>
                    </div>
